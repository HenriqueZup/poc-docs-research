...
1. Abra o terminal e faça o login na sua conta, execute o comando [**stk login**](home/stk-cli/commands/general-commands.mdx#stk-login);
2. Caso esteja logado em sua conta, certifique-se de não estar com nenhum Workspace ativo, execute o comando [**stk exit workspace**](home/stk-cli/commands/workspace-commands.mdx#stk-exit-workspace):
...
3. Execute o comando [**stk apply plugin**](home/stk-cli/commands/plugin-commands.mdx#stk-apply-plugin) como no exemplo a seguir:
...
3. Execute o comando [**stk run action**](home/stk-cli/commands/action-commands.mdx#stk-run-action) como no exemplo a seguir:

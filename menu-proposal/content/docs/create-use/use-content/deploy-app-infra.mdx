...
Você pode configurar o gatilho diretamente no arquivo workflow do StackSpot Self-Hosted. [**Confira o exemplo completo na página de uso do StackSpot Selft-Hosted**](deployment/deploy/use-self-hosted/use-self-hosted-github.md#2-implemente-o-exemplo-do-workflow-na-sua-pipeline).

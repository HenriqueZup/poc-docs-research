...
- Um [**Starter**](home/stackspot/main-concepts.md#starter), que é um modelo pré-definido com as especificações de um conjunto de Plugins. **Escolher um Starter é opcional**.

...
**Passo 4.** Edite o arquivox **`.mdx`** nas pastas **`/docs/pt_br`** e **`/docs/en_us`** com o conteúdo que você quer documentar;
...
**Passo 2.** Escreva as mudanças que você quer fazer no arquivo `.mdx`;

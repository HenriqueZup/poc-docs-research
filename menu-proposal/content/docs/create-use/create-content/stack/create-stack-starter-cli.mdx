...
Se você tem alguma documentação da sua Stack, nomeie o arquivo Markdown da documentação como **`docs.mdx`** e coloque o arquivo nas seguintes pastas:
...
Se você tem alguma documentação do seu Starter, nomeie o arquivo Markdown da documentação como **`docs.mdx`** e coloque o arquivo nas seguintes pastas:
...
Gere uma estrutura básica do Starter dentro de uma Stack. Para isso você pode no momento em que cria a Stack, [**executar o comando para criar a Stack**](home/stk-cli/commands/stack-commands.mdx#stk-create-stack) com a opção **`--from`** para criar o seu Starter a partir de um Stack. Confira a seguir:

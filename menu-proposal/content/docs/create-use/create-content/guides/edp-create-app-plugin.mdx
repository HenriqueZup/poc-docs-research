...
- [**Input do tipo `text`**](create-use/create-content/yaml-files/inputs.md#input-do-tipo-text).
- [**Input do tipo `list`**](create-use/create-content/yaml-files/inputs.md#input-do-tipo-list).
- [**Input do tipo `object`**](create-use/create-content/yaml-files/inputs.md#input-do-tipo-object).

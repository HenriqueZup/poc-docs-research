...
O fork de Plugins de Infraestrutura na StackSpot [**funcionam por meio do comando `stk fork plugin`**](home/stk-cli/commands/plugin-commands.mdx#stk-fork-plugin), que permite que você acesse e edite o Terraform de um Plugin específico, sem expor o Terraform do projeto inteiro. O comando cria uma estrutura padrão de pastas e arquivos para o Terraform do Plugin, possibilitando que você faça alterações personalizadas.

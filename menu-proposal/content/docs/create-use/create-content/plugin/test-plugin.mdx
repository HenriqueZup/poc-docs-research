...
<CustomDocCardList>
  <CustomDocCard title="Crie o seu Estúdio" description="Confira o guia para criar um Estúdio." link="/create-use/studio/create-studio.mdx" />
  <CustomDocCard title="Publique o seu Plugin" description="Confira o passo a passo para publicar um Plugin em seu Estúdio." link="/create-use/create-content/plugin/publish-plugin.mdx" />
</CustomDocCardList>

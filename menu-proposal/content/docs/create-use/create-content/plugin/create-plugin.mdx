...
<ThemedImage alt="Diagrama mostrando os passos para criar e publicar um Plugin e Starter na StackSpot. Passo 1: Criar um Plugin de App. Passo 2: Editar o arquivo YAML do Plugin. Passo 3: Adicionar seus arquivos na pasta templates. Passo 4: Aplicar o Plugin para teste local. Passo 5: Publicar o Plugin. Passo 6: Criar ou acessar uma Stack. Passo 7: Adicionar Plugins à Stack. Passo 8: Criar um Starter" width="auto" sources={{ light: useBaseUrl('/img/diagrams/CRIARPLUGIN-APP-PT-Light.png'), dark: useBaseUrl('img/diagrams/CRIARPLUGIN-APP-PT-dark.png'), }} />

<br/>

## **Criar Plugin de Infra**

<ThemedImage alt="Diagrama mostrando os passos para criar e publicar um Plugin de Infraestrutura na StackSpot. Passo 1: Criar um Plugin de Infraestrutura. Passo 2: Editar o arquivo YAML do Plugin. Passo 3: Adicionar seus arquivos na pasta templates. Passo 4: Aplicar o Plugin para teste local. Passo 5: Publicar o Plugin. Passo 6: Criar ou acessar uma Stack. Passo 7: Adicionar Plugins à Stack. Passo 8: Criar um Starter" width="auto" sources={{ light: useBaseUrl('/img/diagrams/CRIAR-PLUGINNFRA-PT-light.png'), dark: useBaseUrl('img/diagrams/CRIAR-PLUGININFRA-PT-dark.png'), }} />
...
<Tabs groupId="plugin-folders">
<TabItem value="app" label="Plugin do tipo App" default>
...
<TabItem value="infra" label="Plugin do tipo Infra">
...
<CustomDocCardList>
  <CustomDocCard title="Criar e executar testes de Plugins" description="Confira a seção de Testes de Plugins." link="/create-use/create-content/plugin/test-plugin.mdx" />
  <CustomDocCard title="Criar Estúdio" description="Se você não possui um Estúdio, confira como criar um Estúdio para plublicar o seu conteúdo." link="/create-use/studio/create-studio.mdx" />
  <CustomDocCard title="Editar um Plugin" description="Confira mais detalhes sobre como editar os seus Plugins." link="/create-use/create-content/plugin/edit-plugin.mdx" />
</CustomDocCardList>

<!-- 
> Depois de criar um Plugin, se você quiser que o código dele vá para um determinado diretório, é preciso informar na [**Aplicação do Plugin**](home/stk-cli/commands/plugin-commands.mdx/#stk-apply-plugin), através do input, a pasta desejada. Confira um exemplo abaixo:
...
<!-- 
**Passo 3.** Abra a sua IDE e confira o arquivo de configuração do Plugin (arquivo **plugin.yaml**). Você pode ajustar o campo **schema-version** e os campos dentro de **spec** de acordo com o que você precisa.

**Passo 4.** Clique em cada **arquivo .mdx** e confira mais detalhes de como preencher seu YAML. Confira dicas sobre markdown no arquivo **guia-markdown.mdx**. Este é um passo **opcional**.
...
<Tabs groupId="plugin-fields-description">
<TabItem value="v.2" label="v.2 (atual)" default>
...
<Tabs groupId="create-an-infra-plugin">
<TabItem value="v.2" label="v.2 (atual)" default>

...
<CustomDocCardList>
  <CustomDocCard title="Como criar Plugin" description="Passos para criar o seu Plugin." link="/create-use/create-content/plugin/create-plugin.md" />
  <CustomDocCard title="Aprenda a publicar seus Plugin" description="Confira como fazer a publicação do seu Plugin." link="/create-use/create-content/plugin/publish-plugin.md" />
  <CustomDocCard title="Como migrar Plugin v1 para v2" description="Passos para fazer a migração da versão do schema do seu Plugin de v1 para v2." link="/create-use/create-content/plugin/v2-migration-guide.md" />
  <CustomDocCard title="Como usar Jinja na StackSpot" description="Documentação sobre o uso de JINJA na StackSpot." link="/create-use/create-content/yaml-files/jinja.md" />
  <CustomDocCard title="Como criar Plugin Localmente" description="Passos para criar e testar o seu Plugin localmente." link="/create-use/create-content/plugin/create-plugin-tutorial.md" />
  <CustomDocCard title="Como Publicar Plugin via Pipeline" description="Passos para publicar o seu Plugin pela pipeline utilizando uma GitHub Action de publicação da StackSpot." link="/create-use/create-content/plugin/publish-workflow.md" />
</CustomDocCardList>

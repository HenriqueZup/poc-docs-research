...
spec:
  type: infra
  release-notes: docs/release-notes-1.mdx
...
spec: 
  ...
  technologies: 
    - Api
  release-notes: docs/release-notes-{{version}}.mdx 
  requires: #optional
    connection-interface: 
      - lambda-conn             # studio)
  inputs: #optional
...
Para mais detalhes, confira a [**a seção para mapear outputs de uma Connection Interface com os outputs do seu arquivo Terraform**](create-use/create-content/plugin/create-plugin.mdx#mapear-outputs-de-um-arquivo-terraform).
...
Para mais detalhes, confira os exemplos na seção de [**plugin.yaml**](create-use/create-content/yaml-files/plugin-yaml.mdx#specrequiresconnectionsnalias).

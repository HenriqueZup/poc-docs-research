...
<FlowChart steps={[
  ...
  { title: 'Criar Conteúdo', link: 'create-use/create-content/getting-started.md', default: true },
...
O exemplo apresentado anteriormente gera um código que necessita da conexão com um AWS Bucket S3. [**Note que, neste caso, foi utilizado o input do tipo `required-connection`**](create-use/create-content/yaml-files/inputs.md#input-do-tipo-required-connection).
...
- O exemplo anterior mostra como criar uma conexão com um AWS S3 Bucket. [**Observe que, neste caso, foi utilizado um input do tipo generated-connection**](create-use/create-content/yaml-files/inputs.md#input-do-tipo-generated-connection).
...
<CustomDocCardList>
  <CustomDocCard title="Criar Plugins" description="Nesta seção, você encontra um guia de como criar Plugins de App e de Infra." link="/create-use/create-content/plugin/create-plugin.md" />
  <CustomDocCard title="Criar Action" description="Nesta seção, você encontra um guia de como criar uma Action usando o STK CLI." link="/create-use/create-content/action/run-action.md" />
  <CustomDocCard title="Usar Hooks Declarativos" description="Nesta seção você encontra: Como definir e quais são os tipos de Hooks Declarativos. Como executar condicional de um Hook Declarativo." link="/create-use/create-content/declarative-hooks/index.md" />
  <CustomDocCard title="Configurar Arquivos .yaml de Actions e Plugins" description="Nesta seção, você encontra: os arquivos .yaml de Plugin, Actions e demais configurações dos conteúdos." link="/create-use/create-content/yaml-files/index.md" />
  <CustomDocCard title="Usar Variáveis" description="As variáveis na StackSpot fornecem o armazenamento e reuso de informações não sensíveis de configurações." link="/create-use/create-content/variables.md" />
  <CustomDocCard title="Documentar o seu conteúdo" description="Nesta seção, você encontra as regras de escrita de Markdown para criar a sua documentação de conteúdo." link="/create-use/studio/documentation.md" />
  <CustomDocCard title="Criar teste de Plugins" description="Confira como criar testes unitários para os seus Plugins." link="/create-use/create-content/plugin/test-plugin.md" />
</CustomDocCardList>

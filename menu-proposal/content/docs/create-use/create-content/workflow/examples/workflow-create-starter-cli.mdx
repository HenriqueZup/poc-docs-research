...
sidebar_position: 6
description: Exemplo de como criar um Workflow do tipo Create que chama um do tipo Starter.
---

> Nesta seção, você encontra um exemplo detalhado de como criar um Workflow do tipo **Create** que chama um Workflow do tipo **Starter** utilizando o STK CLI da StackSpot.  

...
Confira [**nesta página os campos obrigatórios dos Inputs com os respectivos exemplos**](create-use/create-content/yaml-files/inputs.mdx#campos-obrigatórios-do-input).

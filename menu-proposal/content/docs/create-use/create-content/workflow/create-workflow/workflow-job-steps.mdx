...
description: Entenda como funciona a dependência entre os Jobs de Workflows e os tipos
  de Steps.
---
...
Outra forma de continuar a execução de um Workflow suspenso, é executar [**o comando `stk resume workflow`**](create-use/create-content/workflow/reference/workflow-commands.mdx#stk-resume-workflow) em execuções locais ou em etapas pré-configuradas em uma pipeline.  
...
[**Para mais detalhes sobre o input do tipo lista, confira a página de Inputs**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-list).

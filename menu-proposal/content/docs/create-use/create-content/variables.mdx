...
Os inputs podem ser preenchidos diretamente no terminal ao informar o nome e valor do input no parâmetro **`--inputs-json`** dos comandos [**`stk run action`**](home/stk-cli/commands/action-commands.mdx#stk-run-action) e [**`stk apply plugin`**](home/stk-cli/commands/plugin-commands.mdx#stk-apply-plugin).

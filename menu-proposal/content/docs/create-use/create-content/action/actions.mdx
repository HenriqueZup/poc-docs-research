...
[**Confira mais detalhes sobre o `component_path` em Conteúdo de templates e metadados da Action**](create-use/create-content/action/run-action.mdx#conteúdo-de-templates-e-metadados-da-action).
...
A estrutura de uma Action é gerada pelo STK CLI, com o comando [**`stk create action`**](home/stk-cli/commands/action-commands.mdx#stk-create-action) suportando os seguintes tipos de estrutura definidos pelo parâmetro **`--type`**:

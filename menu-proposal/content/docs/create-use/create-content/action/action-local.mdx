...
Para criar a estrutura inicial da sua Action, execute o comando [**`stk create action`**](home/stk-cli/commands/action-commands.mdx#stk-create-action). Confira o exemplo:
...
- Na pasta da sua Action, execute o comando [**stk publish action**](home/stk-cli/commands/action-commands.mdx#stk-publish-action):

...
Para fazer a execução, a Action tem que estar adicionada no seu Workspace. Para conferir se você está em um Workspace, execute o comando [**`stk use workspace`**](home/stk-cli/commands/workspace-commands.mdxe)

...
<CustomDocCardList>
  <CustomDocCard title="Construções em Typescript" description="Construções suportadas na linguagem Typescript" link="/create-use/create-content/declarative-hooks/code-transformation/typescript-lang.mdx" />
  <CustomDocCard title="Construções em HTML" description="Construções suportadas na sintaxe do HTML" link="/create-use/create-content/declarative-hooks/code-transformation/html-lang.mdx" />
  <CustomDocCard title="Construções em Java" description="Construções suportadas na linguagem Java" link="/create-use/create-content/declarative-hooks/code-transformation/java-lang.mdx" />
</CustomDocCardList>

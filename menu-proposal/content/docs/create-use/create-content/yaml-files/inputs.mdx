...
<CustomDocCardList>
  <CustomDocCard title="Inputs Avançados" description="Confira a seção de Inputs Avançados." link="/create-use/create-content/yaml-files/advanced-inputs.md" />
  <CustomDocCard title="Jinja na StackSpot" description="Confira mais detalhes sobre o uso de Jinja na StackSpot" link="/create-use/create-content/yaml-files/jinja.md" />
</CustomDocCardList>

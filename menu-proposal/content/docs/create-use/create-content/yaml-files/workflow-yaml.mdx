...
description: Informações do arquivo 'workflow.yaml' com as especificações do schema
  e parâmetros do Workflow.
---
...
spec:
  ...
  targets: 
    ...
    - "infra"
  docs:
    pt-br: docs/pt-br/doc.mdx
    en-us: docs/en-us/doc.mdx
  inputs:
   - type: text
     name: text_input

...
description: Detalhes sobre o arquivo de especificação para criação de Aplicações,
  Infraestruturas e uso de Plugins.
---
...
As Connections Interfaces requeridas e geradas passam a ser usadas como Inputs na versão 3 dos manifestos de Plugins e Actions. [**Acesse a página de Inputs para conferir o novo tipo de input `required-connection`**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-required-connection) e [**`generated-connection`**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-generated-connection).  

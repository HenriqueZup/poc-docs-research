...
Essas dependências são definidas por meio de [**Connection Interface**](home/stackspot/main-concepts.mdx#connection-interface) onde cada tipo [**Connection Interface Type**](home/stackspot/main-concepts.mdx#connection-interface-type) provê os recursos necessários para aquela aplicação.
...
No contexto da StackSpot é possível gerenciar a aplicação de Plugins entre si através de uma [**Connection Interface**](home/stackspot/main-concepts.mdx#connection-interface) e [**Connection Interface Type**](home/stackspot/main-concepts.mdx#connection-interface-type)

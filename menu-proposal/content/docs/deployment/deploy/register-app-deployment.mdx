...
**Passo 1.** Configure as chaves de autenticação CI/CD no repositório onde está a sua Aplicação. [**Para isso, siga os passos no guia Autenticar via CI/CD**](/home/stk-cli/pipeline-ci-cd.md#autenticar-via-cicd).
...
- Fazer [**autenticação na Pipeline**](docs/home/stk-cli/pipeline-ci-cd.md#autenticar-via-cicd); 

...
- **Tipo App**: Feito através do comando [**`stk deploy app`**](home/stk-cli/commands/application-commands.mdx#stk-deploy-app), irá fazer o Deploy das peças de Infraestrutura da Aplicação que o Plugin gera;
- **Tipo Infra**: Feito pelo comando [**`stk deploy infra`**](home/stk-cli/commands/infraestructure-commands.mdx#stk-deploy-infra), irá fazer o Deploy das peças de Infraestrutura da [**Infraestrutura**](create-use/use-content/infra/infrastructure.mdx) que o Plugin gera.
...
- [**Ter criado e registrado a Aplicação**](create-use/use-content/application/index.mdx) no [**Workspace**](home/stk-cli/commands/workspace-commands.mdx#stk-use-workspace).
...
> Para saber mais sobre este comando, acesse a página [**Comandos de Workspace**](home/stk-cli/commands/workspace-commands.mdx#stk-use-workspace).

...
description: Detalhes de como gerenciar suas Secrets a nível da Organização.
---
...
**Passo 2.** Selecione a opção **'Organização'**. Depois clique em  **'Identidade e Segurança'**;
...
Para desativar, siga as instruções:

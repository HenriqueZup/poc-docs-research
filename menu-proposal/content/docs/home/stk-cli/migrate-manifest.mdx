...
- [**list**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-list)
- [**object**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-object)
- [**required-connection**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-required-connection)

...
- [**Papéis e Permissões**](home/account/organization/access-management/roles.mdx ).
...
- [**Publicar nova versão de Plugin**](create-use/create-content/plugin/publish-plugin.mdx#versionamento-de-plugin)
...
Para mais informações, confira [**Como criar e adicionar um Starter na Stack**](create-use/create-content/stack/create-stack.mdx#criar-um-starter-na-stack).
...
Para mais informações, confira a seção [**Como criar e adicionar um Starter na Stack**](create-use/create-content/stack/create-stack.mdx#criar-um-starter-na-stack).
...
- Confira o passo a passo detalhado, em [**Adicionar Stack ao Workspace**](home/workspace/stacks-and-context/add-stacks.mdx ).

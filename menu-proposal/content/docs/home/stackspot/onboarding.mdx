...
- [**STK CLI**](home/stk-cli/install.mdx): ferramenta da linha de comando para criar, configurar e automatizar tarefas.
...
**1. Escolha o SCM (Source Code Management) da sua empresa:**  
   - [**GitHub**](home/account/organization/scm-integration/scm-github.mdx)
   - [**Azure**](home/account/organization/scm-integration/scm-azure.mdx)
   - [**GitLab**](home/account/organization/scm-integration/scm-gitlab.mdx)
   - [**Bitbucket**](home/account/organization/scm-integration/scm-bitbucket.mdx)

**2. Configure o StackSpot Self-Hosted Workflow com o seu provedor Cloud:**  
   - Defina como pessoas usuárias da sua organização irão realizar o deploy das Aplicações e Infraestruturas. 
   [**Para fazer a configuração, acesse a página de deployment**](deployment/deploy/use-self-hosted/self-hosted-deploy.mdx).

- [**Para orientações detalhadas sobre cada etapa, consulte o guia de configuração inicial**](home/account/organization/initial-setup.mdx).
...
- [**Criar Aplicação via STK CLI**](create-use/use-content/application/create-app-cli.mdx)  
- [**Criar Aplicação via Portal**](create-use/use-content/application/create-app-portal.mdx)

Já para conferir os passos completos da criação de uma Infraestrutura, acesse uma das páginas a seguir:

- [**Criar Infraestrutura via STK CLI**](create-use/use-content/infra/infrastructure.mdx)  
- [**Criar Infraestrutura via Portal**](create-use/use-content/infra/create-infra-portal.mdx)
...
- [**Fazer o Deployment da Aplicação ou Infraestrutura**](create-use/use-content/deploy-app-infra.mdx)  
- [**Deploy de uma Infraestrutura de Aplicação**](deployment/runtime-engine/app-deployment.mdx)  
- [**Deploy de uma Infraestrutura**](deployment/runtime-engine/deploy-infra.mdx)   
- [**Deploy de uma Infraestrutura de Aplicação via Runtime Self-Hosted**](deployment/deploy/self-hosted-runtime.mdx)  
- [**Registrar deploy da Aplicação**](deployment/deploy/register-app-deployment.mdx)  

#### **Links úteis para a sua jornada**

- [**Primeiros passos para Usar Conteúdo**](create-use/use-content/quickstart.mdx)  
- [**Como preencher Inputs via Portal**](create-use/use-content/configure-inputs.mdx)
- [**Contratos de Connection Interface Types**](create-use/connections/connection-interface-type.mdx)

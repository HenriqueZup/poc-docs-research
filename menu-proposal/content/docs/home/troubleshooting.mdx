...
O erro acontece em cenários de **adição e remoção** de [**Actions que foram definidas como requisitos**](create-use/create-content/plugin/plugin-requirements.mdx#usar-action-como-requisito). 
...
O erro acontece em cenários de **adição e remoção** de [**Connection Interface requerida em um Plugin**](/create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-required-connection). 
...
O erro acontece em cenários de publicação de [**tipos de Inputs**](create-use/create-content/yaml-files/inputs.mdx#tipos-de-input). 
...
O erro acontece em cenários de publicação de [**subtipos de Inputs**](create-use/create-content/yaml-files/inputs.mdx#campos-obrigatórios-do-input). 
...
Esse erro acontece na publicação de [**conditions de Inputs**](create-use/create-content/yaml-files/inputs.mdx#condition) nos seguintes cenários:

- Mudança  
- Remoção  
- Adição de [**variable**](create-use/create-content/yaml-files/inputs.mdx#condition), [**operator**](create-use/create-content/yaml-files/inputs.mdx#condition) ou [**value**](/create-use/create-content/yaml-files/inputs.mdx#value). 
...
O erro acontece em cenários de mudança permissão de [**aplicação de Plugins de Infraestrutura em Aplicações**](create-use/create-content/plugin/plugin-requirements.mdx#permitir-que-o-plugin-de-infraestrutura-seja-aplicado-em-aplicações)
...
Esse erro acontece em cenários de mudança do [**input do tipo required-connection**](create-use/create-content/yaml-files/inputs.mdx#input-do-tipo-required-connection). 

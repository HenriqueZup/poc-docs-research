...
> Atenção: [app.yaml e infra.yaml agora são **app-spec.yaml** and **infra-spec.yaml**](create-use/create-content/yaml-files/spec-file.mdx)
...
- Nova forma para [**criar Aplicações**](/create-use/use-content/application/create-app-portal) e [**Infraestrutura**](/create-use/use-content/infra/infrastructure.mdx) no Portal.
